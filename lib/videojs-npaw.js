    ...
    npaw = function(options) {
        var settings = videojs.util.mergeOptions(defaults, options),
            ...
            elapsedTimeAction = function(current_src) {
                ...
                // HTTP GET Request
                httpGet(settings.api + '?event=play&current_src=' + current_src + '&elapsed_time=' + elapsed_time, function(data) {
            ...
            firstplayAction = function() {
                ...
                // HTTP GET Request
                httpGet(settings.api + '?event=firstplay&current_src=' + current_src, function(data) {
            ...
            endedAction = function() {
                ...
                // HTTP GET Request
                httpGet(settings.api + '?event=ended&current_src=' + current_src, function(data) {
